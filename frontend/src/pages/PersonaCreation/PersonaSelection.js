...
const PersonaSelection = ({ isOpen, onClose, characterId, characterName }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-white rounded-2xl max-h-[85vh] sm:max-h-[90vh] overflow-hidden mx-auto flex flex-col">
        {/* Header - Fixed */}
        ...
        {/* Content - Scrollable */}
        <div className="flex-1 overflow-y-auto min-h-0 overscroll-contain modal-scroll">
          <div className="p-4 pb-6">
            ...
            {/* 멀티프로필 섹션 */}
            <div className="mb-6">
              <h3 className="text-base font-medium text-gray-900 mb-3 text-left">멀티프로필</h3>
              <button
            ...
            {/* 유저 프로필 섹션 */}
            <div className="mb-6">
              <h3 className="text-base font-medium text-gray-900 mb-3 text-left">유저 프로필</h3>
              <div 
                className={`flex items-center justify-between p-4 rounded-xl border-2 cursor-pointer ${
